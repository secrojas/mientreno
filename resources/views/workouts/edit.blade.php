<x-app-layout>
    <div class="max-w-3xl">
        ...
        <form method="POST" action="{{ route('workouts.update', $workout) }}" class="card p-responsive grid gap-5">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="avg_heart_rate" name="avg_heart_rate" type="number"
                           min="40" max="250" value="{{ old('avg_heart_rate', $workout->avg_heart_rate) }}"
                ...
                <div>
                    ...
                    <input id="elevation_gain" name="elevation_gain" type="number"
                           min="0" value="{{ old('elevation_gain', $workout->elevation_gain) }}"
                           placeholder="Opcional" class="form-input">
                </div>
            </div>
